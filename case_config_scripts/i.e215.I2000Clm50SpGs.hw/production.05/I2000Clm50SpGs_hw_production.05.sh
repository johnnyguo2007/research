...
# Log file
CONFIG_ROOT="/home/jguo/research/case_config_scripts/i.e215.I2000Clm50SpGs.hw/production.05"
...
export CASE_NAME="i.e215.I2000Clm50SpGs.hw_production.05"
...
log_and_execute ./xmlchange DATM_CLMNCEP_YR_ALIGN=1985,DATM_CLMNCEP_YR_START=1985,DATM_CLMNCEP_YR_END=2013
log_and_execute ./xmlchange DOUT_S_ROOT="/media/jguo/external_data/simulation_output/archive/case/i.e215.I2000Clm50SpGs.hw_production.05"
