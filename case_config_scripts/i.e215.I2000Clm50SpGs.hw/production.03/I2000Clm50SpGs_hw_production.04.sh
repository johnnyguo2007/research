...
export CASE_NAME="i.e215.I2000Clm50SpGs.hw_production.04"
...
log_and_execute ./xmlchange DOUT_S_ROOT="/media/jguo/external_data/simulation_output/i.e215.I2000Clm50SpGs.hw_production.04"
