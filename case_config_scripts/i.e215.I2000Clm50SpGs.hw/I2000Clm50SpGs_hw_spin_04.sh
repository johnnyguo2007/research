...
export CASE_NAME="i.e215.I2000Clm50SpGs.hw_spinup.03"
...
./xmlchange RUN_STARTDATE=0001-01-01,STOP_OPTION=nyears,STOP_N=1,RESUBMIT=19
#./xmlchange RUN_STARTDATE=0001-01-01,STOP_OPTION=nmonths,STOP_N=1,RESUBMIT=3
./xmlchange DATM_CLMNCEP_YR_ALIGN=1, DATM_CLMNCEP_YR_START=1995,DATM_CLMNCEP_YR_END=2004
