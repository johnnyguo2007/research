...
if __name__ == "__main__":
    ...
    default_image_dir = '/Trex/case_results/i.e215.I2000Clm50SpGs.hw_production.05/research_results/figures_for_paper'
    default_filename = 'Figure_6_anova_by_kg_duration.png'
    default_output_path = os.path.join(default_image_dir, default_filename)
    ...
    parser.add_argument('--output', type=str, default=default_output_path, help=f'Path to save the figure (default: {default_output_path})')
    ...
    default_image_dir = '/Trex/case_results/i.e215.I2000Clm50SpGs.hw_production.05/research_results/figures_for_paper'
    default_filename = 'Figure_6_anova_by_kg_duration.png'
    output_path = os.path.join(default_image_dir, default_filename)
