...
def main():
    ...
    ds_daily_grid_hw = xr.open_dataset('/home/jguo/process_data/i.e215.I2000Clm50SpGs.hw_production.02/summary/daily_grid_hw.nc', chunks='auto')
    ...
    for year in range(start_year, end_year + 1):
        ...
        ds_daily_grid_hw_year = ds_daily_grid_hw.sel(time=ds_daily_grid_hw['time'].dt.year == year)
        ...
        filtered_ds_year = ds_year.where(hourly_mask_year, drop=True)
